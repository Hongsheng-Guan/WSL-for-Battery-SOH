...
def main():
    ...
    for target_dataset in args.target_datasets:
        ...
        # 设置保存文件夹和数据集属性
        # save_folder = os.path.join('results', 'ft_module_effect',target_dataset,'Freeze None')
        # save_folder = os.path.join('results', 'ft_module_effect',target_dataset,'Freeze Conv only')
        # save_folder = os.path.join('results', 'ft_module_effect',target_dataset,'Freeze FC only')
        save_folder = os.path.join('results', 'ft_module_effect',target_dataset,'Unfreeze last fc')
